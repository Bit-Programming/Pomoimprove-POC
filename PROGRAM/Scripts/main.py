...
Label(root, text="Pomoimprove", font=('Helvetica 25 bold'), bg="#AEAEAE").place(relx=.5, rely=.05, anchor=CENTER)
...
spinbox = Spinbox(root, bg="#AEAEAE", from_=0, to=60, increment=5, wrap=True, justify=CENTER, textvariable=minutes).place(relx=.53, rely=.25, relheight=.02, relwidth=.025, anchor=CENTER)
...
Start = Button(root, bg="#3CC249", fg="#FFFFFF", borderwidth=0, text="Start", activeforeground="black", command = countdown(3, True)).place(relx=.50, rely=.80, relheight=.03, relwidth=.05, anchor=CENTER)
Stop = Button(root, bg="#E33E3E", fg="#FFFFFF", borderwidth=0, text="Stop", activeforeground="black", command = countdown(3, False)).place(relx=.50, rely=.85, relheight=.03, relwidth=.05, anchor=CENTER)
